...
module.exports = (robot) ->
  ...
  robot.hear /@DEV/i, (msg) ->
    msg.send "(mboy) Hey @fleeting, @higley, and @CraigKahle, #{msg.message.user.name} has summoned you."
  ...
  robot.hear /.*(coffee me).*/i, (msg) ->
    msg.send "Coffee? You live in Austin! https://scontent-b.xx.fbcdn.net/hphotos-prn2/t1.0-9/10325194_10152473938621742_3748103880787422234_n.jpg"
